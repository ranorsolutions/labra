...
git clone --recursive git@github.com:ranorsolutions/labra.git
...
git submodule update --remote assets/scripts/labra-cli
```
...
git pull
cd ../../..
git add assets/scripts/labra-cli
git commit -m "chore: update Labra CLI"
```
